...
const PrivacyPolicyPage = () => {
  return (
    <div className={styles["wrapper"]}>
      ...
      <div className="custom-code__content">
        <p>
          This website is operated by 4dearest. Throughout the site, the terms
          “we”, “us” and “our” refer to 4dearest. 4dearest offers this website,
        ...
        <p></p>
        <h4 style={{ fontWeight: 600, margin: "12px 0" }}>
        ...
        <p>
          ...
          by us) provided {`'as is' and 'as available'`} for your use, without
        ...
        <p>
          In no case shall 4dearest, our directors, officers, employees,
        ...
        <p>
          You agree to indemnify, defend and hold harmless 4dearest and our
